...
var HexGrid = preload("../../lib/HexGrid.gd").new()

@onready var highlight: Node = get_node("Highlight")
@onready var area_coords: Node = get_node("Highlight/AreaCoords")
@onready var hex_coords: Node = get_node("Highlight/HexCoords")
